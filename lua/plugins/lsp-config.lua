      ...
      lspconfig.jsonls.setup({
        ...
        settings = {
          json = {
            ...
            extra = {
              {
                description = "UI Config Schema",
                fileMatch = { "**/ui-config.json" }, -- or your actual JSON file name
                url = "file:///home/your-user/dev/myproject/app/json-schemas/ui-config.schema.json",
              },
            }
          }
        }
